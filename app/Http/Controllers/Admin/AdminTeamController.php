        ...
        return DataTables::of($usersData)
            ->addColumn('action', function ($row) {
                ...
                if( $this->user->can('edit_team')){
                    $action.= '<a href="' . route('admin.team.edit', [$row->id]) . '" class="btn btn-light btn-circle"
                      data-toggle="tooltip" style="background-color: #4145a0; border-color: #4145a0;" data-original-title="'.__('app.edit').'"><i class="fa fa-pencil" style="color: white;" aria-hidden="true"></i></a>';
                }
