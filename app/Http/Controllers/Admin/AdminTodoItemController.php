    ...
    public function index()
    {
        if (request()->ajax()) {
            ...
            ->addColumn('action', function ($row) {
                $action = '<a href="javascript:showUpdateTodoForm(' . $row->id . ');" class="btn btn-light btn-circle edit-todo" style="background-color: #4145a0; border-color: #4145a0;" data-toggle="tooltip" data-original-title="'.__('app.edit').'"><i class="fa fa-pencil" style="color: white;" aria-hidden="true"></i></a>
