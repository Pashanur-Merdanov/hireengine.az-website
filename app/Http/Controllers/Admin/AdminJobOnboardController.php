    ...
    public function data(Request $request)
    {
        ...
        return DataTables::of($jobApplications)
            ->addColumn('action', function ($row) {
                ...
                $action .= '<a href="' . route('admin.job-onboard.edit', [$row->id]) . '" class="dropdown-item" style="background-color: #4145a0; border-color: #4145a0;"><i class="fa fa-pencil" style="color: white;" aria-hidden="true"></i> '.__('app.edit').'</a>';
