...
<html lang="en">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Sans+serif:200,300,400,400i,500,600,700%7CMerriweather:300,300i" rel="stylesheet">
                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-7">
                            ...
                            <form class="ajax-form" method="POST" id="createForm" onsubmit="return false;">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h5 class="text-uppercase">@lang('modules.register.companyDetails')</h5>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <button type="submit" id="save-form" class="btn btn--primary type--uppercase" style="background-color: #4145a0; border-color: #4145a0; ">@lang('modules.register.createAccount')</button>
                                    </div>
                                    <div class="col-12">
                                        <div>
                                            <span class="type--fine-print">@lang('modules.register.alreadyRegistered')
                                                <a href="{{ route('login') }}" style="color: #4145a0;">@lang('modules.register.login')</a>
                                            </span>
