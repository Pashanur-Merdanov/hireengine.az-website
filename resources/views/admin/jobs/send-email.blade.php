                                ...
                                <div class="col-md-4">
                                    <div class="example">
                                        <div class="input-daterange input-group" id="date-range">
                                            <input type="text" class="form-control" id="start-date" placeholder="@lang('app.ShowResultsFrom')" value="" />
                                            <span class="input-group-addon bg-info b-0 text-white p-1">@lang('app.to')</span>
                                            <input type="text" class="form-control" id="end-date" placeholder="@lang('app.ShowResultsTo')" value="" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-11">
                                                <select class="select2 select2-multiple" name="skill[]" multiple="multiple" id="skill" data-style="form-control" data-placeholder="@lang('app.SelectSkills')">
