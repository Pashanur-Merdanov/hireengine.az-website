        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <a href="{{ route('admin.subscribe.invoice') }}">
                    <button type="button" class="btn btn-light btn-sm pull-right " style="border-color: #4145a0; color: white; background-color: #4145a0;"><i class="ti-receipt"></i> @lang('menu.subscriptionDetails')</button>
                </a>
            </div>
        </div>
    ...
    <div class="col-12">
        <div class="card-deck mb-3 text-center">
            @foreach ($packages as $item)
                <div class="card mb-4 box-shadow monthly-packages" style="border-radius: 15px; box-shadow: 3px 3px 3px #888888;" @if($global->package_type == 'annual')  style="display:none;"  @endif
...
{{--Ajax Modal--}}
<div class="modal fade bs-modal-lg in" id="package-select-form" role="dialog" aria-labelledby="myModalLabel"
     aria-hidden="true">
