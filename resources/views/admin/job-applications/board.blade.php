...
@section('content')
    ...
    <div class="row mb-2">
        <div class="col-sm-6">
            ...
            <a href="{{ route('admin.job-applications.table') }}" class="btn btn-sm btn-primary" style="background-color: #4145a0; border-color: #4145a0;">
    ...
    <div class="container-scroll">
        <div class="card" id="ticket-filters" style="border-radius: 15px; box-shadow: 3px 3px 3px #888888;">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
