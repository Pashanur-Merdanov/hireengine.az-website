                ...
                <div class="row">
                        ...
                        <a href="{{ route('admin.jobs.index') }}" target="_blank">
                            <div class="card" style="border-radius: 15px;">
                                <div class="box bg-light text-center" style="background:transparent; border:3px solid #f8f9fa; border-radius: 15px; box-shadow: 3px 3px 3px #888888;">
                                    <h1 class="font-light" style="color: #4145a0;">{{ $totalOpenings }}</h1>
                                    <h6 class="" style="margin-right: 25px; color: #4145a0;"><div class="foo blue" style="float: left;width: 35px;height: 18px;margin-left: 10px;background:  #17a2b8;border-radius: 4px;" ></div>@lang('modules.dashboard.totalOpenings')</h6>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('admin.job-applications.index') }}" target="_blank">
                            <div class="card" style="border-radius: 15px;">
                                <div class="box bg-light text-center" style="background:transparent; border:3px solid #f8f9fa; border-radius: 15px; box-shadow: 3px 3px 3px #888888;">
                                    <h1 class="font-light" style="color: #4145a0;">{{ $totalApplications }}</h1>
                                    <h6 class="" style="margin-right: 25px; color: #4145a0;"><div class="foo blue" style="float: left;width: 35px;height: 18px;margin-left: 10px;background:  #0000ff;border-radius: 4px;" ></div>@lang('modules.dashboard.totalApplications')</h6>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('admin.job-applications.index') }}" target="_blank">
                            <div class="card" style="border-radius: 15px;">
                                <div class="box bg-light text-center" style="background:transparent; border:3px solid #f8f9fa; border-radius: 15px; box-shadow: 3px 3px 3px #888888;">
                                    <h1 class="font-light " style="color: #4145a0;">{{ $totalHired }}</h1>
                                    <h6 class=" " style="margin-right: 25px;color: #4145a0;"><div class="foo blue" style="border-radius: 4px;float: left;width: 35px;height: 18px;margin-left: 10px;background:  #228B22;"></div>@lang('modules.dashboard.totalHired')</h6>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('admin.job-applications.index') }}" target="_blank">
                            <div class="card" style="border-radius: 15px;">
                                <div class="box bg-light text-center" style="background:transparent; border:3px solid #f8f9fa; border-radius: 15px; box-shadow: 3px 3px 3px #888888;">
                                    <h1 class="font-light  " style="color: #4145a0;">{{ $totalRejected }}</h1>
                                    <h6 class=" " style="margin-right: 25px;color: #4145a0;"><div class="foo blue" style="border-radius: 4px;float: left;width: 35px;height: 18px;margin-left: 10px;background:  black;"></div>@lang('modules.dashboard.totalRejected')</h6>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('admin.job-applications.index') }}" target="_blank">
                            <div class="card" style="border-radius: 15px;">
                                <div class="box bg-light text-center" style="background:transparent; border:3px solid #f8f9fa; border-radius: 15px; box-shadow: 3px 3px 3px #888888;">
                                    <h1 class="font-light  " style="color: #4145a0;">{{ $newApplications }}</h1>
                                    <h6 class=" " style="color: #4145a0;margin-right: 25px;"><div class="foo blue" style="border-radius: 4px;float: left;width: 35px;height: 18px;margin-left: 10px;background:  #ff0000;"></div>@lang('modules.dashboard.newApplications')</h6>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('admin.job-applications.index') }}" target="_blank">
                            <div class="card" style="border-radius: 15px;">
                                <div class="box bg-light text-center " style="background:transparent; border:3px solid #f8f9fa; border-radius: 15px; box-shadow: 3px 3px 3px #888888;">
                                    <h1 class="font-light " style="color: #4145a0;">{{ $shortlisted }}</h1>
                                    <h6 class=" " style="color: #4145a0;margin-right: 25px;"><div class="foo blue" style="border-radius: 4px;float: left;width: 35px;height: 18px;margin-left: 10px;background:  yellow;"></div>@lang('modules.dashboard.shortlistedCandidates')</h6>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-md-6">
                        <a href="{{ route('admin.interview-schedule.index') }}" target="_blank">
                            <div class="card" style="border-radius: 15px;">
                                <div class="box bg-light text-center " style="background:transparent; border:3px solid #f8f9fa; border-radius: 15px; box-shadow: 3px 3px 3px #888888;">
                                    <h1 class="font-light" style="color: #4145a0;">{{ $totalTodayInterview }}</h1>
                                    <h6 class="" style="color: #4145a0;margin-right: 25px;"><div class="foo blue" style="float: left;width: 35px;height: 18px;margin-left: 10px;background:  #0000ff;border-radius: 4px;" ></div>@lang('modules.dashboard.todayInterview')</h6>
                                </div>
                            </div>
                        </a>
                    </div>
