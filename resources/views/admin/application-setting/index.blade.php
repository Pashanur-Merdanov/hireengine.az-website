            ...
            <div class="card"  style="border-radius: 15px; box-shadow: 3px 3px 3px #888888;">
                <div class="card-body">
                    <form id="editSettings" class="ajax-form">
                        ...
                        @method('PUT')
                        <div class="col-md-12">
                            <h4 class="card-title mb-4" style="color: #4145a0;">@lang('modules.applicationSetting.formSettings')</h4>
                        </div>
                        ...
                        <div class="col-md-12">
                            <h4 class="card-title mb-4" style="color: #4145a0;">@lang('modules.applicationSetting.mailSettings')</h4>
                        </div>

                        <div id="mail-setting" class="row">
                            <label style="margin-left: 10px">@lang('app.Sendmailifcandidatemoveto') </label>
                            @forelse($setting->mail_setting as $key => $mailSetting)
                                <div class="form-group" style="margin-left: 20px">
                                    <label class="">
                                        ...
                                        {{ __('modules.jobApplicationStatus.'.camel_case($mailSetting['name'])) }}
                                    </label>
                                </div>
                            @empty
                            @endforelse
