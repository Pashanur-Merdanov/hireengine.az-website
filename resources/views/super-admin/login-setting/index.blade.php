            ...
            <div class="card-body">
                ...
                <form id="editSettings" class="ajax-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="title" name="title" value="{{ $headerData->translation->title }}">
                    </div>
                    <div class="form-group">
                        <label>@lang('modules.frontCms.description')</label>
                        <textarea name="description" class="form-control" id="description" cols="30" rows="4">{!! $headerData->translation->description !!}</textarea>
                    </div>
                    <div class="form-group">
                        <label>@lang('modules.frontCms.callToActionTitle')</label>
                        <input class="form-control" id="call_to_action_title" name="call_to_action_title" value="{{ $headerData->translation->call_to_action_title }}">
                    </div>
                    <div class="form-group">
                        ...
                        <select name="call_to_action_button" id="call_to_action_button" class="form-control">
                            <option
                            @if($headerData->translation->call_to_action_button == 'login') selected @endif
                             value="login">@lang('app.login')</option>
                            <option
                            @if($headerData->translation->call_to_action_button == 'register') selected @endif
                            value="register">@lang('app.register')</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>@lang('modules.frontCms.contactText')</label>
                        <textarea name="contact_text" id="contact_text" class="form-control" cols="30" rows="6">{!! $headerData->translation->contact_text !!}</textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="meta_title" name="meta_details[title]" value="{{ $headerData->translation->meta_details['title'] }}">
                    </div>
                    <div class="form-group">
                        <label for="meta_description" class="control-label">@lang('modules.frontCms.metaDescription')</label>
                        <textarea name="meta_details[description]" id="meta_description" class="form-control" cols="30" rows="3">{!! $headerData->translation->meta_details['description'] !!}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="meta_keywords" class="control-label">@lang('modules.frontCms.metaKeywords')</label>
                        <textarea name="meta_details[keywords]" id="meta_keywords" class="form-control" cols="30" rows="3">{!! $headerData->translation->meta_details['keywords'] !!}</textarea>
                    </div>
