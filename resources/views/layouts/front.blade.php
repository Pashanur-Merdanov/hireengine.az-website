        ...
        <div class="topbar-right">
            <div class="d-inline-flex ml-30 language-drop">
                <div class="dropdown btn btn-default">
                    <a href="#" class="dropdown-toggle text-capitalize" data-toggle="dropdown" style="color: #4145a0;">
...
<!-- Header -->
<header class="header header-inverse" style="padding: 30px;background-image: url({{ $frontTheme->background_image_url }})" data-overlay="8">
