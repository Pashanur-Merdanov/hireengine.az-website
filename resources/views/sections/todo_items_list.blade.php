<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="{{ route('admin.todo-items.index') }}" class="btn btn-sm btn-custom" style="border-radius: 10px;">
        @lang('modules.module.todos.viewAll')
    </a>
</div>

<div id="upper-box" class="todo-box mb-3" style="border-radius: 15px; box-shadow: 3px 3px 3px #888888;">
...
<div id="lower-box" class="todo-box"  style="border-radius: 15px; box-shadow: 3px 3px 3px #888888;">
    <div class="todo-title">
