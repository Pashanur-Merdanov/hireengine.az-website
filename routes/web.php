...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(
        ...
        function () {
            ...
            Route::post('change-language/{code}', 'AdminBaseController@changeLanguage')->name('changeLanguage');
    ...
    Route::group(
        ...
        function () {
            ...
            Route::post('front-cms', ['as' => 'front-cms.updateHeader', 'uses' => 'SuperAdminFrontCmsController@updateHeader']);
